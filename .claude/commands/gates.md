...
Se algum gate falhar, mostre a saída da falha e diagnostique a causa antes de propor conserto. Estes são os mesmos jobs do CI (`.github/workflows/tests.yml`) — verde local significa push verde.
